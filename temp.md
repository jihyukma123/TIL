...
- 화두 몇가지
  ...
  - 내 이름은 단편적인 에피소드에 연결되어 있는가? 아니면 공동체를 위한 서사에 연결돼 있는가?
...
- MCP v1 -> v2 비교해보기
- fighting the urge to 내용 다 떄려넣고 요약해줘 하기
- 회사가 중요하게 생각하는 문제를 해결하는 개발자
  - 기술에만 매몰되지 말아야 한다. 
  - 근데 기본은 해야되지 않나?
  - 어렵네
...
일이 주어졌을 때 해결하는 framework 를 만들고 지속개선하는 작업이 필요하지 않을까?

예를 들어

- 초기에는 그냥 주어지면 일단 함
- 조금 익숙해지고 구조를 이해하면서, 이 일이 왜 하는 것인지를 이해하고 함
- 시간이 지나고 사람들과 관계도 잘 쌓은 상태라면, 이 일을 꼭 해야되는 것인지 안해도 되는 일을 하는건 아닌지 이 방향이 맞는지 등에 대해서 논의하면서 일을 함.

그러면 어떤 일을 시작해보자 어떻게 할까라고 AI한테 입력했을 때
-> 내가 설정한 프레임워크에 맞춰서 처리하도록


## 생각나는 것들

이런 나름의 방법이나 이런 것들이 있어야할 것 같고.

- 6대1의 법칙: 6일은 본업, 1일은 아예 상관없는 분야에 대해서 정보 습득하고 파보기
- 3시간의 법칙: 일주일 근무 중 목/금 중 하루 3시간은 일주일치 업무 전반에 대해서 회고하고 상태 개선하는데 사용하기
